...
echo.
:startonwake
echo Greetings %username%, how may I be of assistance Sir?
%speech% "Greetings %username%, how may I be of assistance Sir?"
:start
echo.
set /p C=Please type/say a command: 
echo.
if "%C%"=="hello there jarvis" goto jarvis
...
:introduce
echo Greetings acquaintance, my name is Jarvis. I am a DLA, a digital life assistant. My main function is to assist the user in any way possible to make ones daily life easier.
%speech% "Greetings acquaintance, my name is Jarvis. I am a DLA, a digital life assistant. My main function is to assist the user in any way possible to make ones daily life easier."
goto start

:shutdown
echo Goodnight, sir.
%speech% "Goodnight, sir."
shutdown -s -t 20
echo.
pause
EXIT
...
echo NO.
::echo Goodbye sir, it was nice knowing you.
::cd..
::del JARVIS\ -f
::cd JARVIS
goto start
...
:fuckoffsir
echo I'm sorry sir, have you been on the drugs again? Kindly shut the fuck up sir. :)
